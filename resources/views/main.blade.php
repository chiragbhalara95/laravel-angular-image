...
<head>
    ...
    <!-- Custom CSS -->
    <link href="{{ URL::asset('front/css/heroic-features.css') }}" rel="stylesheet">
    <link href="{{ URL::asset('front/css/app.css') }}" rel="stylesheet">
    <link href="{{ URL::asset('front/css/cart.css') }}" rel="stylesheet">
...
<script src="{{ URL::asset('front/js/app.js') }}"></script>
